...
class OfferPage extends React.Component {
  ...
  handleOffer = async () => {
    ...
    let expirationDays = this.state.expirationDays;
    ...
    for (let i = 0; i < assets.length; i++) {
      ...
      try {
        const result = await this.props.seaport.createBuyOrder({
          ...
          expirationTime: Math.round(Date.now() / 1000 + 60 * 60 * expirationDays)
        });
        console.log(result);
      ...
      <PageLayout>
        ...
        <Form className="my-4">
          ...
          <div className="d-flex mb-3 align-items-end">
            ...
            <Form.Group controlId="expirationDays" style={{ marginRight: 24 }}>
              <Form.Label>Expiration days from now</Form.Label>
              <Form.Control type="number" placeholder="Enter days number" name="expirationDays" value={this.state.expirationDays} onChange={this.handleChange} />
            </Form.Group>
