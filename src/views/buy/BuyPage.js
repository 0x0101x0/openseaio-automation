...
class BuyPage extends React.Component {
  ...
  handleBuy = async (idx) => {
    ...
    try {
      ...
      const result = await this.props.seaport.fulfillOrder({
        order,
        accountAddress
      });

      console.log(result);
      this.state.assets[idx].status = 'Buy has been successed.';
      this.setState({
      ...
      console.log(err);
      this.state.assets[idx].status = err.message;
      this.setState({
        assets: this.state.assets
      });
    }
              ...
              this.state.assets
                .map((asset, index) =>
                  <tr key={index}>
                    ...
                    <td className="align-middle">
                      <button type="button" className="btn btn-primary" onClick={() => this.handleBuy(index)}>Buy</button>
                    </td>
                  </tr>
                )
            }
